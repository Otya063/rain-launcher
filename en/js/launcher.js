...
function startUpdateProcess() {
    "use strict";
    $(".btn_preferences").hide(), switchEvtPhase("update"),
        _KEY_ACT_DEF = function (e) {
            switch (e.which) {
                case 9:
                    return !1;
...
$(function () {
    ...
    $("p:not(.selectable),img,li,td,th,.unselectable,.btn,.modal").attr("unselectable", "on"),
        ...
        $(".unselectable").mouseover(function () { DoBeginDrag(!1) }), $(".glove,.draggable").hover(function () {
            return DoBeginDrag(!0), !1
        },
            function () { DoBeginDrag(!1) }),
        $(".glove,.draggable").attr("unselectable", "on"),
        $(".glove,.draggable").attr("onSelectStart", "DoBeginDrag(true); return false;"), $(".glove,.draggable").mousedown(function () {
            DoBeginDrag(!0);
